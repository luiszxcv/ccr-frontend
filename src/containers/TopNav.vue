...
<nav class="navbar fixed-top">
    ...
    <div class="navbar-right">
        <div class="d-none d-md-inline-block align-middle mr-2">
        ...
        <div class="header-icons d-inline-block align-middle mr-2">
            ...
            <div class="position-relative d-inline-block mr-2">
                <b-dropdown variant="empty" size="sm" right toggle-class="header-icon notificationButton" menu-class="position-absolute mt-2 notificationDropdown" no-caret>
                    <template slot="button-content">
            ...
            <!--<div class="d-inline-block align-middle mr-3 ">
                <b-button variant="empty" class="header-icon cart_b btn-sm" v-b-modal.modalcart>
                    <i style = "font-size: 25px;" class="iconsminds-shopping-cart" />
                </b-button>
                <span class="contar">{{ cartTotal }}</span>
            </div>-->
        </div>

        <div class="user d-inline-block">
            <b-dropdown class="dropdown-menu-right" right variant="empty" toggle-class="p-0" menu-class="mt-2" no-caret>
                <template slot="button-content">
                ...
                <b-dropdown-item href="https://api.whatsapp.com/send?1=pt_BR&phone=5566996181212" target= '_blank'>Suporte</b-dropdown-item>
                <b-dropdown-divider />
